    ...
    private fun buildCaptureScreen() {
        ...
        listToggleButton.setOnClickListener {
            ...
            if (retrieveRequested) {
                ...
                // Hiding the matching list must not strand the user with only name fields.
                capturePhoneSection.visibility = View.VISIBLE
                captureSaveButton.visibility = View.VISIBLE
            }
        }
