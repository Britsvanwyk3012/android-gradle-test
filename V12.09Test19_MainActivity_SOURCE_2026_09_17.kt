...
class MainActivity : ComponentActivity() {
    ...
    private fun saveOrUpdate() {
        ...
        val now = System.currentTimeMillis()
        val existingRecord = selected?.let { clientDb.getClient(it.id) }
            ...
            if (normalizedPhone.isNotBlank()) {
                db.query("clients", arrayOf("id", "main_phone", "additional_phone", "whatsapp"), null, null, null, null, "id ASC").use { cursor ->
                    while (cursor.moveToNext()) {
                        ...
                        if (normalizedPhone == normalizePhone(mainPhone) && (normalizedPhone == main || normalizedPhone == additional || normalizedPhone == whatsapp)) {
